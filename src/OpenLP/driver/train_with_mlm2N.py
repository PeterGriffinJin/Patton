# This code script is for contrastive training (without [MASK]) with in batch negative samples + mlm.
# In this pipeline, text with [MASK] and text without [MASK] both need go through a forward loop. (2 forward in total)
...
from OpenLP.dataset import TrainLM2Collator, TrainDataset, EvalDataset
from OpenLP.modeling import DenseLM2NModel
...
def main():
    ...
    trainer = trainer_cls(
        ...
        data_collator=TrainLM2Collator(
            tokenizer,
