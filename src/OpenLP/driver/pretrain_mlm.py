# This code script is for mlm pretrain. (This one is slightly different with pretrain.py in that GraphFormers can also be mlm pretrained with the script here.)
...
from OpenLP.modeling import DenseMLMModel
